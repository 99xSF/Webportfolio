...
export const gridItems = [
  {
    id: 1,
    title: "I prioritize detail orientation, collaboration, fostering open communication ",
    description: "",
  ...
  {
    id: 2,
    title: "I'm flexible with all opportunities",
    description: "",
  ...
  },
  {
    id: 3,
    title: "My tech stack",
    description: "I constantly try to improve and learn",
    className: "lg:col-span-2 md:col-span-3 md:row-span-2",
    imgClassName: "",
  ...
  {
    id: 5,
    title: "Currently building a AgeWell program for yoga at home",
